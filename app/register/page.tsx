    ...
    <div className="flex h-full items-center justify-center p-5 bg-[#0f172a]">
      <div className="w-full max-w-sm space-y-6">
        <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-white text-center tracking-tight m-0">Mulai Petualangan</h2>
            <p className="text-[0.85rem] text-[#94a3b8] text-center mt-2 m-0">Daftar untuk tantangan otak harian</p>
        </div>
        ...
        <p className="text-center text-[0.85rem] text-[#64748b]">
          Sudah punya akun?{" "}
          <Link href="/login" className="text-[#3b82f6] hover:text-white font-semibold transition-colors">
            Masuk
          </Link>
        </p>
      </div>
